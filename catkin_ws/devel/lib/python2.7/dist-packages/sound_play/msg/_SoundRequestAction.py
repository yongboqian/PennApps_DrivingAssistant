...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2bf.pack(_x.action_goal.goal.sound_request.sound, _x.action_goal.goal.sound_request.command, _x.action_goal.goal.sound_request.volume))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B5I.pack(_x.action_result.result.playing, _x.action_result.result.stamp.secs, _x.action_result.result.stamp.nsecs, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B2I.pack(_x.action_feedback.feedback.playing, _x.action_feedback.feedback.stamp.secs, _x.action_feedback.feedback.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.sound_request.sound, _x.action_goal.goal.sound_request.command, _x.action_goal.goal.sound_request.volume,) = _struct_2bf.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.playing, _x.action_result.result.stamp.secs, _x.action_result.result.stamp.nsecs, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B5I.unpack(str[start:end])
      ...
      (_x.action_feedback.feedback.playing, _x.action_feedback.feedback.stamp.secs, _x.action_feedback.feedback.stamp.nsecs,) = _struct_B2I.unpack(str[start:end])
