...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'squirtle_voice_command' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yongbo/Documents/PennApps_DrivingAssistant/catkin_ws/install/${idir}'.  Ask the maintainer 'parallels <parallels@todo.todo>' to fix it.")
    endif()
