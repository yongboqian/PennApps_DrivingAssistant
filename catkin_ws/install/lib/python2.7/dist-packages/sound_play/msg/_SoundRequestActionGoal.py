...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2bf.pack(_x.goal.sound_request.sound, _x.goal.sound_request.command, _x.goal.sound_request.volume))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.sound_request.sound, _x.goal.sound_request.command, _x.goal.sound_request.volume,) = _struct_2bf.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
